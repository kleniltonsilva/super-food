...
class BotConfig(Base):
    ...
    # Registro de telefone (self-service onboarding)
    phone_registration_status = Column(String(30), default='none')
    phone_display_name = Column(String(200))
    phone_about = Column(Text)
    phone_description = Column(Text)
    phone_profile_photo_url = Column(String(500))
    phone_registered_at = Column(DateTime)
